                        ...
                        <div class="content-with-sidebar">
                            ...
                            <table class="table vps-hosting-pricing-table domain-search-result-table alert-table mb-5">
                                ...
                                <tr class="vps-pricing-row">
                                    ...
                                    <td>
                                        <a href="http://whmcs.themetags.com/cart.php?systpl=kohost-professional&a=add&domain=transfer&query=<?php echo $domainName; ?>" class="btn btn-brand-01 btn-sm">Add to Cart</a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
